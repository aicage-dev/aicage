...
- **Custom sample**: relevant, but narrower, newer, more specialized, or less proven as a durable default.
...
| Aider         | Broad, established    | Keep custom                    | Widely recognized, but below the built-in priority cut-off. |
