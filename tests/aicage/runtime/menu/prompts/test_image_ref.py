...
class PromptImageRefTests(TestCase):
    def test_prompt_for_image_ref_returns_default_on_empty(self) -> None:
        with (
            mock.patch("aicage.runtime.menu.prompts.image_ref.ensure_tty_for_prompt"),
    ...
    def test_prompt_for_image_ref_returns_default_when_non_interactive_defaults_enabled(self) -> None:
        ...
        with (
            ...
            mock.patch("aicage.runtime.menu.prompts.image_ref.ensure_tty_for_prompt") as tty_mock,
